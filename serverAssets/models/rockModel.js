...
var rockSchema = Mongoose.Schema({
	...
	lat: {type: Number, required: true, unique: true, precision: 6},
	lon: {type: Number, required: true, unique: true, precision: 6},
	trailHead: {type: Boolean, required: true},
	trailLat: {type: Number, precision: 6},
	trailLon: {type: Number, precision: 6},
